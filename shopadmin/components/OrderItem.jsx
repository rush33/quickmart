const OrderItem = ({ date, id, total, status, address }) => {
  const orderTimeStamp = new Date(date);
  const options = {
    day: "2-digit",
    month: "short",
    year: "numeric",
  ...
  return (
    <>
      ...
      <td className="pr-6 py-4 text-base whitespace-nowrap overflow-hidden text-ellipsis max-w-[150px]">
        {address}
      </td>
